...
public class JanelaCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/close_1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int idCliente = cadastrarCliente(); // pega o ID do cliente salvo

        if (idCliente > 0) {
            cadastrarVeiculo(idCliente); // usa o ID para vincular o veículo
        } else {
    ...
    private int cadastrarCliente() {
        ...
        objClienteDAO.setNome(jTextField1.getText());
        objClienteDAO.setCpf(jTextField2.getText());
        objClienteDAO.setTelefone(jTextField3.getText());
        objClienteDAO.setCidade(jTextField4.getText());

        return objClienteDAO.cadastrarCliente(objClienteDAO);
    }

    private void cadastrarVeiculo(int idCliente) {
        VeiculoDAO objVeiculoDAO = new VeiculoDAO();

        objVeiculoDAO.setIdCliente(idCliente);
        objVeiculoDAO.setPlaca(jTextField5.getText());
        objVeiculoDAO.setMarca(jTextField6.getText());
        objVeiculoDAO.setModelo(jTextField7.getText());
        objVeiculoDAO.setCor(jTextField8.getText());

        objVeiculoDAO.cadastrarVeiculo(objVeiculoDAO);
    }
}
